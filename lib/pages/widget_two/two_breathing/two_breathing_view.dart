...
class TwoBreathingPage extends StatefulWidget {
  @override
  State<TwoBreathingPage> createState() => _TwoBreathingPageState();
}

class _TwoBreathingPageState extends State<TwoBreathingPage> {
  final logic = Get.put(TwoBreathingLogic());
