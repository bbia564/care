...
class TwoHeartPage extends StatefulWidget {
  @override
  State<TwoHeartPage> createState() => _TwoHeartPageState();
}

class _TwoHeartPageState extends State<TwoHeartPage> {
  final logic = Get.put(TwoHeartLogic());
