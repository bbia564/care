...
class TwoTemperaturePage extends StatefulWidget {
  @override
  State<TwoTemperaturePage> createState() => _TwoTemperaturePageState();
}

class _TwoTemperaturePageState extends State<TwoTemperaturePage> {
  final logic = Get.put(TwoTemperatureLogic());
